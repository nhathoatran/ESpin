    ...
    if (_notEquals) {
      ...
      for (final ConfigProcess proc : _procinit) {
        ...
        if (_notEquals_1) {
          ...
          PeriodicProcess _periodic_5 = proc.getPeriodic();
          int _max = _periodic_5.getMax();
          boolean _notEquals_2 = (_max != 0);
          if (_notEquals_2) {
            PeriodicProcess _periodic_6 = proc.getPeriodic();
            String _periodicClockVariable_2 = Data.getPeriodicClockVariable(_periodic_6);
            PeriodicProcess _periodic_7 = proc.getPeriodic();
            int _max_1 = _periodic_7.getMax();
            String _string_2 = Integer.valueOf(_max_1).toString();
            Data.periodicClockLimit.put(_periodicClockVariable_2, _string_2);
          }
        }
      }
    }
