...
public class Handler {
  ...
  public static String getNewProcessFunction(final PeriodicProcess periodic, final ProcessDSL procModel) {
    ...
    _builder.newLineIfNotEmpty();
    {
      String _periodicClockVariable_2 = Data.getPeriodicClockVariable(periodic);
      String _get_1 = Data.periodicClockLimit.get(_periodicClockVariable_2);
      boolean _notEquals = (!Objects.equal(_get_1, null));
      if (_notEquals) {
        _builder.append("\t");
        _builder.append("if (");
        String _periodicClockVariable_3 = Data.getPeriodicClockVariable(periodic);
        _builder.append(_periodicClockVariable_3, "\t");
        _builder.append("_count <= ");
        String _periodicClockVariable_4 = Data.getPeriodicClockVariable(periodic);
        String _get_2 = Data.periodicClockLimit.get(_periodicClockVariable_4);
        _builder.append(_get_2, "\t");
        _builder.append("){");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        String _periodicClockVariable_5 = Data.getPeriodicClockVariable(periodic);
        _builder.append(_periodicClockVariable_5, "\t\t");
        _builder.append("_count ++;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        ...
        _builder.newLine();
        {
          ...
          boolean _notEquals_1 = (!Objects.equal(_paraAssign, null));
          if (_notEquals_1) {
            {
        ...
        _builder.append("\t");
        _builder.append("PromelaProcess proc = panmodel.new ");
        Element _element_6 = periodic.getElement();
        scheduling.dsl.Process _process_1 = _element_6.getProcess();
        ...
        _builder.append("\t");
        _builder.append("int id = SchedulerPanModel.panmodel.newProcess(proc, ");
        int _max_1 = periodic.getMax();
        _builder.append(_max_1, "\t");
        _builder.append(", \"");
        Element _element_7 = periodic.getElement();
        String _periodicProcessKey_3 = Handler.getPeriodicProcessKey(_element_7, procModel);
        _builder.append(_periodicProcessKey_3, "\t");
        _builder.append("\");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.newLine();
        ...
        _builder.newLine();
        {
          Element _element_8 = periodic.getElement();
          EList<Value> _paraAssign_2 = _element_8.getParaAssign();
          boolean _notEquals_3 = (!Objects.equal(_paraAssign_2, null));
          if (_notEquals_3) {
            {
              Element _element_9 = periodic.getElement();
              EList<Value> _paraAssign_3 = _element_9.getParaAssign();
              for(final Value par_1 : _paraAssign_3) {
                {
                  NumValue _num_2 = par_1.getNum();
                  boolean _notEquals_4 = (!Objects.equal(_num_2, null));
                  if (_notEquals_4) {
                    _builder.append("\t");
                    _builder.append("\t");
                    _builder.append("para.add(\"");
                    NumValue _num_3 = par_1.getNum();
                    int _value_2 = _num_3.getValue();
                    ...
                    _builder.append("\t");
                    _builder.append("para.add(\"");
                    BoolValue _bool_1 = par_1.getBool();
                    String _value_3 = _bool_1.getValue();
        ...
        _builder.append("\t");
        _builder.append("//throw new ValidationException(\"Can not execute new process ");
        Element _element_10 = periodic.getElement();
        String _periodicProcessKey_4 = Handler.getPeriodicProcessKey(_element_10, procModel);
        _builder.append(_periodicProcessKey_4, "\t\t");
        _builder.append("\") ;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("Util.println(\"Can not execute new process ");
        Element _element_11 = periodic.getElement();
        String _periodicProcessKey_5 = Handler.getPeriodicProcessKey(_element_11, procModel);
        _builder.append(_periodicProcessKey_5, "\t\t");
        _builder.append(" - Number of processes reaches limit\") ;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
