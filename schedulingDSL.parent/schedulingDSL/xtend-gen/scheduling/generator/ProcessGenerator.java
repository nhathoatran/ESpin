...
public class ProcessGenerator {
      ...
      for (int i = 0; (i < proc.getParalist().getPara().size()); i++) {
        {
          ...
          String _genStringConvertFunction = ProcessGenerator.genStringConvertFunction(_string, (("para.get(" + Integer.valueOf(i)) + ").trim()"));
          result = (_result + _genStringConvertFunction);
  ...
  public static String genStringConvertFunction(final String type, final String param) {
    boolean _equals = Objects.equal(type, "int");
    if (_equals) {
      return (("Integer.parseInt(" + param) + ")");
    }
    boolean _equals_1 = Objects.equal(type, "byte");
    if (_equals_1) {
