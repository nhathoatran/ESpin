...
public class SchedulerGenerator {
  ...
  public static CharSequence SchedulerClassHeader() {
    ...
    _builder.append("import sspinja.scheduler.promela.model.SchedulerPromelaModel;");
    _builder.newLine();
    _builder.append("import sspinja.Config;");
    _builder.newLine();
  ...
  public static CharSequence genDataStruture(final SchedulerDef sch) {
    ...
    {
      Set<String> _keySet_2 = Data.periodicClockLimit.keySet();
      for(final String pClock_2 : _keySet_2) {
        {
          int _length_1 = pClock_2.length();
          boolean _notEquals_9 = (_length_1 != 0);
          if (_notEquals_9) {
            _builder.append("//limitation of the periodic process");
            _builder.newLine();
            _builder.append("public int ");
            _builder.append(pClock_2, "");
            _builder.append("_count = 0 ; //max : ");
            String _get = Data.periodicClockLimit.get(pClock_2);
    ...
    }
    {
      ...
      if (_notEquals_10) {
        ...
        _builder.newLineIfNotEmpty();
        {
          SchedulerDataDef _schedulerdata_1 = sch.getSchedulerdata();
          EList<DataDef> _datadef = _schedulerdata_1.getDatadef();
          boolean _notEquals_11 = (!Objects.equal(_datadef, null));
          if (_notEquals_11) {
            {
              SchedulerDataDef _schedulerdata_2 = sch.getSchedulerdata();
              EList<DataDef> _datadef_1 = _schedulerdata_2.getDatadef();
              for(final DataDef schdata : _datadef_1) {
                {
                  ...
                  boolean _notEquals_12 = (!Objects.equal(_datablockdef, null));
                  if (_notEquals_12) {
                    {
                      ...
                      for(final DataSingleDef schdat : _datadef_2) {
                        {
                          ...
                          boolean _notEquals_13 = (!Objects.equal(_prop, null));
                          if (_notEquals_13) {
                  ...
                  } else {
                    {
                      ...
                      boolean _notEquals_14 = (!Objects.equal(_prop_1, null));
                      if (_notEquals_14) {
                                  ...
                                  if (((!Objects.equal(vas_5.getType().toString().trim(), "bool")) && (!Objects.equal(vas_5.getType().toString().trim(), "time")))) {
                                    {
                                      ...
                                      boolean _notEquals_15 = (!Objects.equal(_ivalue_7, null));
                                      if (_notEquals_15) {
                                        _builder.append("public int ");
  ...
  public static CharSequence genUtilitiesFunctions(final SchedulerDef sch) {
    ...
    {
      Set<String> _keySet_1 = Data.periodicClockLimit.keySet();
      for(final String pClock_1 : _keySet_1) {
        _builder.append("\t");
        _builder.append("size += 4 ; //clock ");
        _builder.append(pClock_1, "\t");
  ...
  public static CharSequence genEncodeDecode(final SchedulerDef sch) {
    ...
    }
    {
      ...
      for(final String pC_1 : _keySet_1) {
        ...
        _builder.append("_writer.writeInt(");
        _builder.append(pC_1, "\t");
        _builder.append("_count) ; // periodic process count");
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.append("\t");
    ...
    {
      Set<String> _keySet_2 = Data.periodicClockProperties.keySet();
      for(final String pC_2 : _keySet_2) {
        _builder.append("\t");
        _builder.append(pC_2, "\t");
    ...
    {
      Set<String> _keySet_3 = Data.periodicClockLimit.keySet();
      for(final String pC_3 : _keySet_3) {
        _builder.append("\t");
        _builder.append(pC_3, "\t");
        _builder.append("_count = _reader.readInt() ; // periodic process count");
        _builder.newLineIfNotEmpty();
      }
    }
    _builder.append("\t");
